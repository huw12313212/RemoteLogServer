...
(function() {
    ...
    function z(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++)
                this.stripLines.push(new ma(this.chart, this._options.stripLines[b], a.theme,
    ...
    w.prototype._updateOptions = function() {
        ...
        !1), ka(a._zoomButton, a._resetButton)) : (this.zoomEnabled=!0, this.panEnabled=!1))) : this.panEnabled = this.zoomEnabled=!1;
    ...
    w.prototype.getDataPointAtXY = function(a, b, c) {
        ...
        for (c = 0; c < d.length; c++)
            if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type)
                if (e = S("markerSize", d[c].dataPoint, d[c].dataSeries) || 8, d[c].distance <= e / 2) {
                    b=!0;
                    break
                }
        for (c = 0; c < d.length; c++)
    ...
    w.prototype.getObjectAtXY = function(a, b, c) {
        ...
        if (c = this.getDataPointAtXY(a, b, c ||!1))
            ...
            d = sa(a, b, this._eventManager.ghostCtx);
        else 
            ...
            if (this._ignoreNextEvent)
                ...
                if (!e) {
                    if (w.capturedEventParam)
                        d =
                        w.capturedEventParam, "mouseup" === c && (w.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y);
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                if (this.panEnabled)
                    ...
                    (d = this.axisX.sessionVariables.internalMaximum - this.axisX._absoluteMaximum, this.axisX.sessionVariables.internalMaximum -= d, this.axisX.sessionVariables.internalMinimum -= d, e=!0), e && this.render();
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < l.length) {
                    for (var r=!1, k = 0; k < l.length; k++)
                        if (n = l[k].x.getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin ||
    ...
    w.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < l.length) {
                    for (var r=!1, k = 0; k < l.length; k++)
                        if (n = l[k].getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof l[k].y)
                                0 < k && (b.stroke(), u && c.stroke()), r=!0;
                            else {
                                var p = m;
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3)
                    c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), u && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), 0 < b && 0 === b%3E3 && (c.stroke(), c.beginPath(), c.moveTo(a[b + 3].x, a[b + 3].y), u && (d.stroke(), d.beginPath(), d.moveTo(a[b + 3].x, a[b + 3].y)));
                c.stroke();
                u && d.stroke()
            }
        }
    ...
    w.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)
                    for (var r = 5 < k && n.bevelEnabled?!0 : !1, e = 0; e < m.length; e++)
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < k.length) {
                    ...
                    for (c.lineWidth = h.lineThickness; n < k.length; n++)
                        if (m = k[n].x.getTime ? k[n].x.getTime() : k[n].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < g.length) {
                    ...
                    for (0 < p.lineThickness && b.stroke(); 0 < t.length;)
                        w = t.pop(), b.lineTo(w.x, w.y), u && m.lineTo(w.x,
                        w.y);
                    b.closePath();
                    b.globalAlpha = p.fillOpacity;
                    b.fill();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                for (l = 0; l < t.length; l++)
                    s = t[l].x.getTime ? t[l].x.getTime() : t[l].x, v.dataPointIndexes[s] =
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof w.y) {
                            ...
                            f[k] = n - h;
                            if (x)
                                b.beginPath(), b.moveTo(q,
                                h), u && (p.beginPath(), p.moveTo(q, h)), x=!1;
                            else if (b.lineTo(q, h), u && p.lineTo(q, h), 0 == l%250) {
        ...
        if (!(0 >= c)) {
            ...
            for (var q =- Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                for (var n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, p = 0, e = 0; e < r.length; e++)
                    f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z ||
                    (p = r[e].z, p > q && (q = p), p < h && (h = p));
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)
        ...
        if (!(0 >= c)) {
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                ...
                if (0 < n.length) {
                    ...
                    2, 2);
                    for (var m = 0, r = 0, e = 0; e < n.length; e++)
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < s.length)
                    for (var v = 5 < n && p.bevelEnabled?!0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? k = s[e].x.getTime() : k = s[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" ===
                        typeof s[e].y[3]) {
    ...
    z.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c = pa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; pa(b, this.interval,
            this.intervalType)
            ...
            for (b = this.intervalStartPosition; b <= c; b = parseFloat((b + this.interval)
                .toPrecision(12)))a = "axisX" === this.type && this.labels[b] ? this.labels[b] : W(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
    ...
    w.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        "doughnut" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            if (0 <= c.type.indexOf("stacked"))
                l = 0, q = b.x.getTime ? b.x.getTime() : b.x, q in c.plotUnit.yTotals && (l = c.plotUnit.yTotals[q], g = isNaN(b.y) ? 0 : 100 * (b.y / l));
            ...
            do {
                ...
                if (c.percentFormatString)
                    ...
                    for (var q = "#,##0.", h = Math.max(Math.ceil(Math.log(1 /
                    g) / Math.LN10), 2), k = 0; k < h; k++)
                        q += "#";
